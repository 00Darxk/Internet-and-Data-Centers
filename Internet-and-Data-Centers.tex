...
\section{Trasmissioni Efficienti TCP}
...
Anche il \texttt{match} è opzionale, in questo caso si comporta come un filtro, applicando le operazioni della \texttt{set} a tutti i pacchetti. 
...
L'unico router di AS200 deve avere la flag disattivata di \texttt{ebpg-requires-policy}, per permettere alle rotte annunciate da BGP di essere inserite come fossero definite da \texttt{network}. 
