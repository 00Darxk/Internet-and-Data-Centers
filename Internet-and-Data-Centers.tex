...
\begin{minted}{bash}
    ...
    ip link add {vtep-vni-1} id {vni-1} dev lo dstport 4789 local {indirizzo-lo} nolearning
    ...
    ip link add {vtep-vni-n} id {vni-n} dev lo dstport 4789 local {indirizzo-lo} nolearning
...
\begin{minted}{bash}
    ...
    ip lnk set dev eth0 master {nome-br}
    ...
    ip lnk set dev eth{n} master {nome-br}
